                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                ...
                                <h2 data-animation="fadeInUp" data-delay="300ms"><?php echo $musicData['music_name'] ?? 'Kesariya' ?> <span><?php echo $musicData['music_name'] ?? 'Kesariya' ?></span></h2>
...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query="INSERT INTO `feedback`(`user_name`, `user_email`, `user_subject`, `user_message`) VALUES ('$name','$email','$subject','$message')";
