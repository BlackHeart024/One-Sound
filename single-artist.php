...
?>
    ...
    <section class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/bg-img/breadcumb3.jpg);">
        <div class="bradcumbContent">
            <p>Artist</p>
            <h2><?php echo $artistData['artist_name'] ?? '-'; ?></h2>
        </div>
    </section>
    <!-- ##### Breadcumb Area End ##### -->
<?php if (!empty($artistData)) { ?>
            ...
            <center>
                ...
                <div class="col-12 col-sm-4 single-album-item">
                    <div class="single-album">
                        <img style="height: 350px; width: 350px;" src="./admin/uploads/artist/<?php echo $artistData['artist_pic'] ?? 'default.jpg';  ?>" alt="" class="rounded-circle">
                        <div class="album-info">
                                <h5><?php echo $artistData['artist_name'] ?></h5>
                            <p>Artist</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            <!-- Single Song Area -->
                <?php
                    $query = "SELECT * FROM `music` where artist_id = '$artist_id'";
                ...
                <div class="col-12 ">
                    <div class="single-song-area mb-30 d-flex flex-wrap align-items-end">
                        <div class="song-thumbnail">
                            <img style="height:125px; width:125px;" src="./admin/uploads/music/photo/<?php echo $musicRow['music_photo'] ?? 'default.jpg';  ?>" alt="">
                        </div>
                ...
                ?>       
                <h5> Not any Song for this Artist </h5>
                <?php 
                }
                ?>
